...
| Q-11 | Có cần luật sư/BA duyệt câu chữ xác nhận quyền (vi + en) trước khi lên production không? | POLICY §3 | `unknown` | **go-live.** Nay còn rộng hơn: Phase 2 thêm ~30 khoá câu chữ do agent viết. **Đã có BẢN NHÁP để luật/BA duyệt**: `docs/Q11_LEGAL_WORDING_DRAFT.md` (`D-067`) — 3 rủi ro kèm câu đề xuất song ngữ. Bản nháp **chưa có hiệu lực**, `Rights Statement v1/v2` **không bị đụng**, **không tạo v3** |
