...
- **Cập nhật**: 2026-09-16 (Phase 2, tới `P2-MCP-30`) · **Quyết định**: Q-16 / D-029
...
4. MINI-SPEC **mới bắt buộc** dùng canonical ID có tiền tố phase (Phase 2 dùng `P2-MCP-23…`; tới `P2-MCP-30` đã dùng).
...
`P1.1-MCP-16` … `P1.1-MCP-19`, `P1.1-Q20-MCP-20`, `P1.1-Q22-MCP-22`, `P1.1-Q21-MCP-21`, `P2-MCP-23`, `P2-MCP-24`, `P2-MCP-25`, `P2-MCP-26`, `P2-MCP-27`, `P2-MCP-28`, `P2-MCP-29`, `P2-MCP-30`.

> Lưu ý: số `20` đã dùng bởi `P1.1-Q20-MCP-20`, số `21` bởi `P1.1-Q21-MCP-21`, số `22` bởi
> `P1.1-Q22-MCP-22`. Để tránh mọi khả năng hiểu nhầm, **Phase 2 bắt đầu từ `P2-MCP-23`** (đã dùng; tiếp theo là `P2-MCP-31`).
>
